...
function TemperatureSensor(dev) {
	...
	this.attr('Temperature', 'msTemperatureMeasurement.measuredValue', function(v) { return v/100; });
	this.attr('Humidity', 'msRelativeHumidity.measuredValue', function(v) { return v/100; });
